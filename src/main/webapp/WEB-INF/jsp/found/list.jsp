...
<div class="main-container">
    ...
    <div class="custom-card">
        <div class="card-title">
            <span><i class="layui-icon layui-icon-template-1"></i>拾到物品列表</span>
...
<script>
    layui.use(['layer', 'laypage', 'form'], function () {
        ...
        function loadData(page) {
            ...
            showLoading();
            ajaxRequest('/api/found/list', 'GET', params, function (data) {
                hideLoading();
        ...
        function renderList(list) {
            if (!list || list.length === 0) {
                $('#itemList').html('<div class="empty-state"><i class="layui-icon layui-icon-face-surprised"></i><p>暂无拾到物品记录</p></div>');
                return;
            }
            var html = '';
            list.forEach(function (item) {
                ...
                html += '<div class="item-card" onclick="window.location.href=\'/item/detail?type=found&id=' + item.id + '\'">';
